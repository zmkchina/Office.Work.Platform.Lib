namespace Office.Work.Platform.Lib
{
    ...
    public class MemberSettings
    {
        ...
        public MemberSettings()
        {
            ...
            MemberPostArr = new string[] { "无", "主任", "副主任", "科长", "副科长", "股长", "副股长", "办事员", "专技人员", "工会主席", "工会副主席" };
            MemberPartyPostArr = new string[] {"无","党总支书记", "党总支副书记", "党总支委员", "党支部书记", "党支部副书记", "党支部委员", "团总支书记", "团支部书记" };
            DepartmentArr = new string[] { "领导班子", "综合科", "政工科", "财务审计科", "发展计划科", "安全运行科", "航道养护科", "船闸事务科", "工程建设科", "港口业务科", "科技信息科", "工会", "政秘股", "养护股", "运调股", "财务股" };
            EducationArr = new string[] { "硕士", "研究生", "本科", "专科", "中专", "高中", "初中及以下" };
            DegreeArr = new string[] { "无", "硕士", "研究生", "学士" };
            ...
            MemberTypeArr = new string[] { "聘用合同制", "劳动合同制", "劳务派遣制", "离退休人员" };
            NationTypeArr= new string[] { "汉族", "满族", "维吾尔族", "苗族", "蒙古族", "羌族", "白族" };
        }
        /// <summary>
        ...
        /// </summary>
        public string[] MemberTypeArr { get; set; }
        /// <summary>
        /// 民族：汉族、满族、维吾尔族、苗族、蒙古族、羌族、白族
        /// </summary>
        public string[] NationTypeArr { get; set; }
    }
}
